...
import { appAlert, getAssetPfx, isLocalHost } from "./Utils";
import { useAuth } from "./auth/use-auth-client";

export const UploadNew = ({ asset, setAsset, assets, setAssets, setDisabledButs, label, show = false, accept = "image/*" }) => {
    ...
    const detailsFromKey = (key) => {
        ...
        const width = Number.parseInt(fileName.split(".").slice(-3)[0]);
        const height = Number.parseInt(fileName.split(".").slice(-2)[0]);
