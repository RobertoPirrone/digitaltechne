  ...
  if (what === "autore") {
    ...
    return (
      <div>
        ...
        <Select
          options={tipoluogoOptions}
          onChange={handlePullDownChange}
          name="tipoluogo"
          placeholder={t("dossier:tipoluogo")}
  ...
  return (
    <div>
      ...
      <Dialog id="form-dialog" open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
        ...
        <DialogContent>
          <DialogContentText>Aggiungere i dati del nuovo {t("dossier:" + props.what)}</DialogContentText>
          <AddDialogElements
            what={props.what}
            autore={autore}
            luogo={luogo}
            tipoopera={tipoopera}
            tipoluogoOptions={props.tipoluogoOptions}
            t={t}
            handleInputChange={handleInputChange}
            handlePullDownChange={handlePullDownChange}
          />
        </DialogContent>
        <DialogActions>
